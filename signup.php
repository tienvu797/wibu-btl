                    ...
                    <form class="main_form">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <input class="form-control" placeholder="Tên đăng nhập" type="text" name="">
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <input class="form-control" placeholder="Họ và tên" type="text" name="">
                            </div>
                            <div class=" col-md-12">
                                <input class="form-control" placeholder="Email" type="text" name="">
                            </div>
                            <div class="col-md-12">
                                <input class="form-control" placeholder="Mật khẩu " type="password" name="">
                            </div>
                            <div class="col-md-12">
                                <input class="form-control" placeholder="Nhập lại mật khẩu" type="password" name="">
                            </div>
                            <div class=" col-md-3">
                                <button class="send">Đăng ký</button>
                            </div>
                        </div>
                    </form>
                </div>
